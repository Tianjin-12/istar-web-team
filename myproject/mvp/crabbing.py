...
def collect_answers_with_db(keyword):
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            page1.fill(
                "//div[@class='ds-form-item__content']//input[@type='text']", phone
            )
            page1.fill(
            ...
            try:
                ...
                for i, q in enumerate(questions, 1):
                    try:
                        ...
                        # 调用爬取函数
                        answer_text, links = crabbing(
                            browser, q["index"], q["question"]
                        )
                ...
                # 确保context和page1被正确关闭
                if page1 and not page1.is_closed():
                    page1.close()
